...
SELECT counter, window_start FROM userapi_password_reset_limits WHERE limit_key = $1 FOR UPDATE
`
...
func NewPostgresPasswordResetLimitTable(db *sql.DB) (tables.PasswordResetRateLimitTable, error) {
